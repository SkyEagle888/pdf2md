...
|------|-------------|--------|
| `testdata/text_en.pdf` | Text-based PDF, English, includes code block | ✅ Generated via `scripts/create_test_pdfs.py` |
| `testdata/text_cjk.pdf` | Text-based PDF, mixed Traditional + Simplified Chinese | ✅ Generated via `scripts/create_test_pdfs.py` |
| `testdata/scanned_en.pdf` | Scanned/image-based PDF, English | ✅ Generated via `scripts/create_test_pdfs.py` |
| `testdata/scanned_cjk.pdf` | Scanned/image-based PDF, Chinese | ✅ Generated via `scripts/create_test_pdfs.py` |
| `testdata/mixed_images.pdf` | Text-based PDF with embedded images | ✅ Generated via `scripts/create_test_pdfs.py` |

Note: Test PDFs are generated by running `python scripts/create_test_pdfs.py`.
The `testdata/*.pdf` files are gitignored to keep the repository lightweight.
